...
      
      // 生图模型
      'GPT Image': "GPT Image的生图模型擅长将抽象或复杂的文字描述转化成图像，适合创意概念可视化和风格模仿。例如：帮我生成一张蓝色神秘黑豹的数字艺术图，风格类似中世纪壁画 / 我要一张未来城市的科幻风景图，带有霓虹灯和飞行汽车 / 帮我做一张梦幻森林的插画，带有发光的蘑菇和精灵",
...
      'Sora2': "Sora2擅长保持角色和场景高度一致性，支持多视角切换，适合影视级别创作和连贯动作表现。例如：帮我生成一个角色在不同场景下连贯动作的视频，保持人物外观一致 / 我要一段短片，展示同一角色在城市和森林两种环境中的活动 / 帮我做一段多镜头切换的动作戏，保证人物动作流畅且连贯",
